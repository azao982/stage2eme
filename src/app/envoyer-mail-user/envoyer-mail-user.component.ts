...
@Component({
  selector: 'app-envoyer-mail-user',
  templateUrl: './envoyer-mail-user.component.html',
  styleUrls: ['./envoyer-mail-user.component.css']
})
export class EnvoyerMailUserComponent {
  email: string = '';
  password: string = '';
  mails : Email[]=[];
  mail : Email;
